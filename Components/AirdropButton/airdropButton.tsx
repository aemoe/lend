...
import styles from "./airdropButton.module.scss"
import { AIRDROP_ABI, AIRDROP_V2_ABI } from "../../pages/libs/abi";
...
const AirdropButton: React.FC<Props> = (props : Props) => {
    ...
    return (
            ...
            <div className={styles.airdrop_button + ` ${!props.spinner ? styles.airdrop_button_hover : styles.airdrop_button_spinner}`} onClick={() => props.spinner ? null : handleOpenAirdropMenu()}>
                <div className={styles.airdrop_button_content}>
                    {totalAmount.length > 0 ? 
                        <>
                            <span className={styles.airdrop_name}><StarBpro active={true} backstop={false}/></span>
                            <span className={styles.airdrop_amount}>
                ...
                {props.spinner ? 
                    <div className={styles.airdrop_spinner}><Spinner size={"30px"}/></div>
                    : null
                }
            </div>
            : null
